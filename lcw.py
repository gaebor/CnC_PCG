...
if __name__ == "__main__":
    parser = ArgumentParser(
        description='Extract LCW Packed content from text file.\n'
    ...
    parser.add_argument(
        "-L", dest="lcw", default=True, help="don't LCW decompress", action="store_false"
    )
    parser.add_argument("--ini", "-i", dest="ini", default=3, help="NewINIFormat", type=int)
